...
epicsShareExtern dset *pvar_dset_S7RedundantPLCAi;
...
epicsShareExtern dset *pvar_dset_S7RedundantPLCAo;
epicsShareExtern dset *pvar_dset_devBiSoft;
epicsShareExtern dset *pvar_dset_devBiSoftRaw;
epicsShareExtern dset *pvar_dset_S7RedundantPLCBi;
epicsShareExtern dset *pvar_dset_S7RedundantPLCStat;
...
epicsShareExtern dset *pvar_dset_S7RedundantPLCBo;
epicsShareExtern dset *pvar_dset_devCalcoutSoft;
epicsShareExtern dset *pvar_dset_devCalcoutSoftCallback;
epicsShareExtern dset *pvar_dset_S7RedundantPLCCalcout;
...
epicsShareExtern dset *pvar_dset_S7RedundantPLCMbbo;
...
epicsShareExtern dset *pvar_dset_S7RedundantPLCMbboDirect;
...
epicsShareExtern dset *pvar_dset_S7RedundantPLCStringin;
...
epicsShareExtern dset *pvar_dset_S7RedundantPLCStringout;
epicsShareExtern dset *pvar_dset_devSASoft;
epicsShareExtern dset *pvar_dset_devWfSoft;
epicsShareExtern dset *pvar_dset_S7RedundantPLCWaveform;
...
static const char * const deviceSupportNames[57] = {
    ...
    "S7RedundantPLCCalcout",
    "devEventSoft",
    "devLiSoft",
    "devLiGeneralTime",
    "S7RedundantPLCLongin",
    "devLoSoft",
    "devLoSoftCallback",
    "S7RedundantPLCLongout",
    "devMbbiSoft",
    "devMbbiSoftRaw",
    "S7RedundantPLCMbbi",
    "S7RedundantPLCStat2",
    ...
    "S7RedundantPLCMbboDirect",
    "devSiSoft",
    "devTimestampSI",
    "devSiGeneralTime",
    "S7RedundantPLCStringin",
    "devSoSoft",
    "devSoSoftCallback",
    "devSoStdio",
    "S7RedundantPLCStringout",
    "devSASoft",
    "devWfSoft",
    "S7RedundantPLCWaveform",
    "devXxxSoft"
};
...
epicsShareExtern void (*pvar_func_S7RedundantPLCRegister)(void);
epicsShareExtern void (*pvar_func_sncExampleRegistrar)(void);
epicsShareExtern void (*pvar_func_sncExample2Registrar)(void);
epicsShareExtern void (*pvar_func_sncExample3Registrar)(void);
...
epicsShareExtern int *pvar_int_S7RedundantPLCDebug;
static struct iocshVarDef vardefs[] = {
	...
	{"S7RedundantPLCDebug", iocshArgInt, (void * const)pvar_int_S7RedundantPLCDebug},
	{NULL, iocshArgInt, NULL}
};

int test_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/Users/huangziyu/EPICS/ioc/hls_pss";
    ...
    (*pvar_func_S7RedundantPLCRegister)();
    (*pvar_func_sncExampleRegistrar)();
    (*pvar_func_sncExample2Registrar)();
    (*pvar_func_sncExample3Registrar)();
